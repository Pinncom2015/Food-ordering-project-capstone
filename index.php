    ...
    <div class="modal-dialog modal-full-height  modal-md" role="document">
      ...
      <div class="modal-body">
        ...
        <footer class="bg-light py-5">
            <div class="container"><div class="small text-center text-muted">CSIS 484 Captstone Project by Brandon Cook | <a href="https://www.liberty.edu/" target="_blank">Liberty University</a></div></div>
        </footer>
